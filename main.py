...
def logInPg():
    ...
    # Button Log in
    btn_login = Button(login, text="Log In", fg="blue", relief="raised", bd=3, width=7, height=2)
    btn_login.place(x=380, y=150)

    # Label Sign up
    lbl_signUp = Label(login, text="Não tem conta?", fg="blue")
    lbl_signUp.place(x=245, y=125)

    # Button Sign up
    btn_signUp = Button(login, text="Criar Conta", fg="blue", relief="raised", bd=3, width=10, height=2)
    btn_signUp.place(x=250, y=150)
...
# Button Log In Page
btn_Login = Button(main, text="Log In", fg="blue", relief="raised", bd=3, width=15, height=2, font=("TkDefaultFont", "12", "bold"), command=logInPg)
btn_Login.place(x=720, y=40)

# Button Log In Page
btn_SignUp = Button(main, text="Sign Up", fg="blue", relief="raised", bd=3, width=15, height=2, font=("TkDefaultFont", "12", "bold"), command=signUpPg)
btn_SignUp.place(x=890, y=40)

# Button Catalogue
imageIconCat = PhotoImage(file="images\\catal_img.png")
btn_cat = Button(panel1, text="Catalogue", fg="blue", relief="raised", bd=3, width=300, height=80, font=("TkDefaultFont", "20", "bold"), image=imageIconCat, compound=RIGHT)
btn_cat.place(x=80, y=40)

# Button Search
imageIconSearch = PhotoImage(file="images\\search_img.png")
btn_ser = Button(panel1, text="Search", fg="blue", relief="raised", bd=3, width=300, height=80, font=("TkDefaultFont", "20", "bold"), image=imageIconSearch, compound=RIGHT)
btn_ser.place(x=80, y=150)

# Button User Profile
imageIconUser = PhotoImage(file="images\\user_img.png")
btn_user = Button(panel1, text="User Profile", fg="blue", relief="raised", bd=3, width=300, height=80, font=("TkDefaultFont", "20", "bold"), image=imageIconUser, compound=RIGHT)
btn_user.place(x=80, y=260)

# Button Close
imageIconClose = PhotoImage(file="images\\close_img.png")
btn_close = Button(panel1, text="Close", fg="blue", relief="raised", bd=3, width=300, height=80, font=("TkDefaultFont", "20", "bold"), image=imageIconClose, compound=RIGHT, command=main.destroy)
